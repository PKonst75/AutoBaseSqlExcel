...
namespace AutoBaseSql
{
    ...
    class PrintRD37:PrintDocumentBase
    {
        // НЕИЗМЕНЯЕМЫЕ ДАННЫЕ
        ...
        const float MAINHEAD_ROW_HEIGHT = 4;
        ...
        protected readonly Font _fontArial5;
        ...
        public PrintRD37(DtCard srcCard) : base()
        {
        ...
        protected void RestoreStandartTool()
        {
            _printTools.SelectTextBoxOffsetX(TEXT_OFFSET_X);
            _printTools.SelectFont(_fontArial5);
