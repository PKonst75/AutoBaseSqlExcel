...
{
	/// <summary>
	/// Summary description for DbEngineType.
	/// </summary>
	public class DbEngineType : Db
	{
		private long			code;
		...
		public DbEngineType(DbEngineType src)
		{
			code			= src.code;
			description		= src.description;
		}
		public DbEngineType(SqlDataReader reader, int offset)
		{
		...
		public static void Init(SqlConnection connection)
		{
			...
			cmdWrite = new SqlCommand("WRITE_ДВИГАТЕЛЬ_ТИП", conn);
			...
			cmdSelect = new SqlCommand("SELECT_ДВИГАТЕЛЬ_ТИП", conn);
		...
		public bool Write()
		{
			...
			SetTransaction(null);
			if(adding) MessageBox.Show("Новый тип двигателя добавлен");
			else
				if(changed) MessageBox.Show("Тип двигателя изменен");
			return true;
		}
		#endregion
		...
		{
			DbEngineType element = new DbEngineType(reader, 0);
